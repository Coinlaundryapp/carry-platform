...
- **Linkerd + Flagger** 기반 서비스 메시와 카나리 배포
- 모놀리스에서 **마이크로서비스로의 점진적 전환** 시나리오 실증
...
| [07-observability.md](07-observability.md) | Observability, 서비스 메시, 카나리 배포 |
| [08-testing.md](08-testing.md) | 테스트 전략 (단위 ~ E2E, 마이크로서비스 테스트) |
| [09-roadmap.md](09-roadmap.md) | 마이그레이션 로드맵, 마이크로서비스 분리, 배포 전략 |
