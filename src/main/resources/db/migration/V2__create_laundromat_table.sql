...
CREATE INDEX idx_laundromat_images_laundromat_id ON laundromat_media_resources (laundromat_id);
CREATE INDEX idx_laundromat_images_laundromat_id_media_url ON laundromat_media_resources (laundromat_id, media_url);
