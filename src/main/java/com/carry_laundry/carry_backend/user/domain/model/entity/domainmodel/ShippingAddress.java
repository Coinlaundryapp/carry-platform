...
public class ShippingAddress {
    ...
    public static ShippingAddress create(Long userId, String addressLabel, String recipientName,
        String recipientPhone,
        String baseAddress, String detailAddress, String deliveryNotes, EntranceType entranceType,
        String entranceDetail) {
        return new ShippingAddress(null, userId, null, addressLabel, recipientName, recipientPhone,
            baseAddress, detailAddress, deliveryNotes, entranceType, entranceDetail);
    }
