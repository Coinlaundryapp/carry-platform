...
public class AdditionalOptionPriceResolver extends AbstractOptionPriceResolver {
    ...
    private void initializeFoldLaundry() {
        ...
        this.foldLaundryMap.put(new OptionCondition(OrderUnitType.SOLO, OrderRequestType.NEW,
            LaundryItemType.REGULAR_AND_BLANKET), 1000);
    ...
    private void initializeAddSoftener() {
        this.addSoftenerMap.put(
            new OptionCondition(OrderUnitType.SOLO, OrderRequestType.NEW, LaundryItemType.REGULAR),
            0);
        this.addSoftenerMap.put(
            new OptionCondition(OrderUnitType.SOLO, OrderRequestType.NEW, LaundryItemType.BLANKET),
            0);
        this.addSoftenerMap.put(new OptionCondition(OrderUnitType.SOLO, OrderRequestType.NEW,
            LaundryItemType.REGULAR_AND_BLANKET), 0);
