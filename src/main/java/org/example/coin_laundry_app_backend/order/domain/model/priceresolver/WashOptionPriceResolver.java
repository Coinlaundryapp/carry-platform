...
public class WashOptionPriceResolver extends AbstractOptionPriceResolver {
    ...
    private void initializeStandard() {
        this.standardPriceMap.put(new OptionCondition(OrderUnitType.SOLO, OrderRequestType.NEW, LaundryItemType.REGULAR), 4500);
        this.standardPriceMap.put(new OptionCondition(OrderUnitType.SOLO, OrderRequestType.NEW, LaundryItemType.BLANKET), 4500);
        this.standardPriceMap.put(new OptionCondition(OrderUnitType.SOLO, OrderRequestType.NEW, LaundryItemType.REGULAR_AND_BLANKET), 4500);
        this.standardPriceMap.put(new OptionCondition(OrderUnitType.SOLO, OrderRequestType.NEW, LaundryItemType.SHOES), 4500);
    }

    private void initializeHotWater() {
        this.hotWaterPriceMap.put(new OptionCondition(OrderUnitType.SOLO, OrderRequestType.NEW, LaundryItemType.REGULAR), 5000);
        this.hotWaterPriceMap.put(new OptionCondition(OrderUnitType.SOLO, OrderRequestType.NEW, LaundryItemType.BLANKET), 5000);
        this.hotWaterPriceMap.put(new OptionCondition(OrderUnitType.SOLO, OrderRequestType.NEW, LaundryItemType.REGULAR_AND_BLANKET), 5000);
